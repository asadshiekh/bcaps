...
const BookNow = () => {
  ...
  const handleDateChange = (selectedDates) => {
    // Format the selected date to a 12-hour format with AM/PM
    const formattedDate = format(selectedDates[0], "yyyy-MM-dd hh:mm a"); // 12-hour format with AM/PM
    
    setFormData({
      ...formData,
      pickupDate: formattedDate, // Store formatted date
    });
  };
