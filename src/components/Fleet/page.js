...
const Fleet = () => {
  return (
    ...
    <div className="banner-block absolute top-0 left-0 right-0 bottom-0 bg-[#0000004f] text-white text-center flex items-center">
        ...
        {/* Gallery Cards */}
   {/* Gallery Cards */}
<div className="cars-gallery py-10 px-5 lg:px-0">
    <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <GalleryCard 
                cat="sedan" 
                title="Suzuki Dzire" 
                des="One of the most sought out car for Kochi City Travel and Kerala Tour Packages alike, this is an ideal & compact sedan for cruising through the landscapes and beaches of Kerala for you and your family." 
                seats="5" 
                miles="680-915mm"  
                luggage={["1 Large Suitcase", "1 Traveller Bag"]} 
                imagetag="/images/assets/kochi-city-taxi-dzire-flee-1.png"
            />
            <GalleryCard 
                cat="sedan" 
                title="Toyota Etios" 
                des="Most ideal vehicle for Kerala Tour Packages. Backed by Toyota's legendary Quality, Durability and Reliability, you'll find this family-sized sedan a home away from home, wherever the road of Kerala takes you." 
                seats="5" 
                miles="680-915mm" 
                luggage={["2 Large Suitcase + 1 Traveller Bag"]} 
                imagetag="/images/assets/kochi-city-taxi-etios-fleet-2.png" 
            />
            <GalleryCard 
                cat="MUV" 
                title="Suzuki Ertiga" 
                des="Suzuki Ertiga, Kerala's favorite taxi! With its spacious interior, fuel efficiency, and reliable performance, the Ertiga is perfect for navigating the beautiful landscapes of Kerala." 
                luggage={["3 Large Suitcase + 1 Medium Suitcase + 1 Traveller Bag"]} 
                imagetag="/images/assets/kochi-city-taxi-ertiga-fleet-3.png"
            />
            <GalleryCard 
                cat="Ultra Luxury MUV" 
                title="Toyota Innova Crysta" 
                des="Experience seamless travel in Kerala with our premier taxi fleet, featuring the Toyota Innova Crysta. Renowned for its spacious interiors, reliability, and performance, the Innova Crysta is the perfect companion for your journey, whether for business or leisure. Trust us to elevate your travel experience and make a statement." 
                seats="5" 
                miles="750-990mm" 
                luggage={["3 Large Suitcase + 1 Medium Suitcase + 1 Traveller Bag"]} 
                imagetag="/images/assets/kochi-city-taxi-dzire-flee-1.png"
            ...
            <GalleryCard 
                ...
                des="One of the most sought out car for Kochi City Travel and Kerala Tour Packages alike, this is an ideal & compact sedan for cruising through the landscapes and beaches of Kerala for you and your family." 
                seats="5"  
                luggage={["10,12,14,17 and 26 Seaters", "10, 12, 14, 17 and 26 Seaters", "8, 10, 12 and 16 Seaters"]} 
                imagetag="/images/assets/kochi-city-taxi-force-traveller-fleet-5.png"
            />
            <GalleryCard 
                cat="Coach" 
                title="Mercedes Benz 35/45 Seater Bus" 
                des="Experience seamless travel with our premier coach, from the epitome of Luxury - Mercedes Benz. Perfectly suited for Kerala's diverse terrain, our luxurious coaches offer unparalleled comfort and style. Ideal for business or leisure, also its a favorite among the group travellers and piligrims coming down to Sabarimala via flight and train" 
                seats="5" 
                miles="680-915mm" 
                luggage={["1 Suitcase + 1 Traveller bag per person"]} 
                imagetag="/images/assets/kochi-city-bus-rental-taxi-fleet-6.png"
            />
        </div>
    </div>
</div>
    ...
    <div className="container mx-auto bg-gray-200 p-5 md:p-10 lg:p-20 rounded-md">
        {/* Top Grid */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
            <div>
                ...
                <p className="text-gray-700">We provide vehicles on a yearly contract basis by branding them with your logo and uniform, enhancing your brand visibility. At present, we cater on a similar basis to various hotels, hospitals, and corporates. Some of our clients in this sector are BCPL, KTDC, etc.</p>
            </div>
            <div>
                <h4 className="font-semibold">Corporate Transportation Packages</h4>
                <p className="text-gray-700">Our expert transportation coordinators shall collect your requirements to create a custom package for your organization. This ensures all of your needs are met. No organization is too large or too small for our reliable and experienced transportation services!</p>
            </div>
            <div>
