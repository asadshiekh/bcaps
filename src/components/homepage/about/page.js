...
const About = () => {
  return (
    <div className="container mx-auto text-center py-20 px-4 sm:px-6 md:px-8">
        <h4 className="mb-5 text-2xl sm:text-3xl md:text-4xl font-medium">
          Welcome! This is <span className="text-[#ed2124]">BCabs Ride Easy...</span>
        </h4>
        ...
        <Link href='/book-now' className='border border-red bg-[#ed2124] px-6 py-2 rounded-md text-white inline-block hover:bg-[#ed2124] hover:border-[#ed2124] cursor-pointer'>
          Book Now!
        </Link>
    </div>
  )
