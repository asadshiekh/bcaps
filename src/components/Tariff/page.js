      ...
      <div className="rates-sec py-10 px-4">
        <div className="container mx-auto">
          <p className="mb-3">
            ...
            Pickup and Drop should be within Kochi City Limits (OR) Pickup and
            Drop should be within Airport Limits Else return to the respective
            City or Airport Limit will be charged.
          </p>
          ...
          <p className="my-5">
            *For Outstation Transfers/drop including the return km shall be
            charged and is applicable only for destinations above 35Kms from
            Cochin Airport or Ernakulam City Centre
          </p>
          <p className="mb-5">
            <strong>Garage to Garage Billing: </strong>Mileage run shall be
            calculated either from our City Garage and back to our City Garage
            (OR) from our Airport Garage and back to our Airport Garage.
          </p>
            ...
            <table className="border border-1 border-gray-300 w-full text-center">
              ...
              <tbody>
                <tr>
                  <th
                    colspan="8"
                    className="z-10 text-left border border-2 border-gray-400 p-2 bg-gray-200"
                  >
                    Force Traveller
                    <br />
                    <span className="text-gray-600">
                      A/C Executive Coach (Van)
                    </span>
                  </th>
                </tr>
                <tr>
                  <th className="border border-2 border-gray-400 p-2 bg-gray-200 sticky left-0">
                    10 Seater
                  </th>
          ...
          <div className="my-5">
            <h6 className="font-semibold text-gray-700 mb-5">
              General Terms and Conditions
            </h6>
            <ul className="list-disc ml-5 space-y-2">
              <li>
                GST (Goods and Service Tax) Included. The above indicated rates
                are inclusive of Goods and Service Tax at 5.00%
              </li>
              <li>
                Rates indicated are exclusive of Toll, Parking & Other permit
                charges.
              </li>
              <li>
                Mileage run for Hatchback and Sedan vehicles would be charged on
                a point to point basis from City Limits & back to City Limits
                (OR) Airport and back to Airport
              </li>
              <li>
                Mileage run for all other vehicles except Hatchback & Sedan,
                would be charged from our City Garage and back to our City
                Garage (OR) from our Airport garage and back to our Airport
                garage.
              </li>
          ...
          <div className="my-5">
            <h6 className="font-semibold text-gray-700 mb-5">
              Day Package T&C: (ONLY APPLICABLE FOR DAY PACKAGES)
            </h6>
            <ul className="list-disc ml-5 space-y-2">
              <li>Day Package applicable for booking of 2 days and more.</li>
              <li>
                Though vehicle is at disposal, Vehicle usage is limited to
                8-10hrs per day including waiting considering the safety of
                passengers and proper rest for the Driver
              </li>
              <li>
                Considering the safety of passengers and chauffeur working
                hours, the vehicle usage is restricted during 7.00 pm to
                preceding day 08.00 am, Airport/Railway transfer on pickup and
                departure day shall be flexible as per the respective flight or
                train timing.
              </li>
              <li>
                Non Tour Packages: Either facility for driver accomodation
                should be provided or an additional night bata of Rs.500 per
                night shall be applicable, along with the km run from/to the
                nearest lodging facility.
              </li>
            </ul>
          </div>
        </div>
